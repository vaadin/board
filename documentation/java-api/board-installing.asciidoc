...
Vaadin Board 1.0.0 requires Vaadin 8.0 or later.
...
You can purchase Vaadin Board or obtain a free trial key from the
link:https://vaadin.com/directory#addon/vaadin-board[Vaadin Board download
