...
IMPORTANT: Vaadin Board is is currently being developed and only available in the Vaadin Framework 8.1 prerelease versions, starting from 8.1.0.beta1.
There is no vaadin-archetype available for this version, so you can not generate the application.
You need to add vaadin prerelease repository to your POM.xml and change vaadin dependencies to 8.1.0.beta1 in you existing vaadin project.
...
&lt;dependency&gt;
    ...
    &lt;version&gt;[replaceable]##1.0.0-alpha5##&lt;/version&gt;
&lt;/dependency&gt;
----
