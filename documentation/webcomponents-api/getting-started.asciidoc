...
https://vaadin.com/directory/component/vaadinvaadin-board[vaadin-board] is a regular https://vaadin.com/docs/v11/flow/web-components/introduction-to-webcomponents.html[web component], which you can add to any web page. It can be used both with and without https://www.polymer-project.org/2.0/docs/about_20[Polymer 2].
