...
public class BoardWriterTest {
    ...
    "<vaadin-board size-full> \n" +
    " <vaadin-board-row> \n" +
    "  <vaadin-label size-full plain-text board-cols=\"2\">\n" +
    "    1-1 \n" +
    "  </vaadin-label> \n" +
    " </vaadin-board-row> \n" +
    "</vaadin-board>";
    ...
    private static final  String BOARD_WITH_INNER_ROW_WITH_BOARDCOLS_CONFIG =
        "<vaadin-board size-full> \n" +
            " <vaadin-board-row> \n" +
            "  <vaadin-board-row board-cols=\"2\"> \n" +
            "   <vaadin-label plain-text board-cols=\"2\">\n" +
            "     1-1 \n" +
            "   </vaadin-label> \n" +
            "  </vaadin-board-row> \n" +
            " </vaadin-board-row> \n" +
    ...
    protected String write(Board object) {
        ...
        try {
            ...
            Element board = Jsoup.parseBodyFragment(doc).body().child(0);
