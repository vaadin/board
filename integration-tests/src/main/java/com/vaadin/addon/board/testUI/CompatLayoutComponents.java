...
public class CompatLayoutComponents {
   ...
   *
   */
  public static class FormLayoutCompUI extends AbstractTestCompUI {
    @Override
  ...
  public static class HorizontalLayoutCompUI extends AbstractTestCompUI {
    @Override
    protected Component[] createTestedComponents() {
   ...
   *
   */
  public static class VerticalLayoutCompUI extends AbstractTestCompUI {
    @Override
    protected Component[] createTestedComponents() {
  ...
  public static class GridLayoutCompUI extends AbstractTestCompUI {
      @Override
      protected Component[] createTestedComponents() {
  ...
  public static class CSSLayoutCompUI extends AbstractTestCompUI {
    @Override
    protected Component[] createTestedComponents() {
